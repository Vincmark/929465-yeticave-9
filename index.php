...
if ($dbConnection == false) {
    ...
    // Зачитываем лоты
    $sql = 'select l.title, start_price, lot_img, stop_date, c.title as category_title from lots l join categories c on l.id_category = c.id where date_reg < stop_date  order by date_reg desc';
